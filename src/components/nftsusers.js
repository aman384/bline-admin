...
export default class nftsusers extends Component {
        ...
        this.columns = [
...

            {
                ...
                cell: (item) => {
                    return (
                        <>
                            {item.telent_status === 0 ? <span style={{ color: '#ff9f00' }}>Pending</span> :
                                item.telent_status === 1 ? <span style={{ color: 'green' }}>Approved</span> :
                ...
                cell: (item) => {
                    return (
                        <>
                            ...
                            <button type="submit" data-toggle="modal" onClick={this.getNftUserDetailAPI.bind(this, item.user_id)} data-target="#responsive-modal1" className="btn-primary" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </button>&nbsp;
    ...
    nftUserDetail = event => {
        ...
        this.setState(prevState => ({
            nftUserData: { ...prevState.nftUserData, [event.target.name]: value }
        }))
    }
            ...
            buttons: [
                {
                    ...
                    onClick: () =>
                        axios({
                            ...
                            data: { 'email': id.email, 'user_id': id.user_id }
                        })
                            .then(result => {
    ...
    async nftsuserList() {
        await axios.get(`${config.apiUrl}getUserTelent`, {},)
            .then(result => {
    ...
    async getNftUserDetailAPI(id) {

        await axios({
            method: 'post',
            url: `${config.apiUrl}getUserTalentById`,
            headers: { "Authorization": this.loginData.Token },
            data: { "user_id": id }
        }).then(response => {
            if (response.data.success === true) {
                this.setState({
                    nftUserData: response.data.response
                })
            }
        })
    }
    ...
    async updateNftUser(e) {
        ...
        await axios({
            method: 'post',
            url: `${config.apiUrl}updateTalentUser`,
            headers: { "Authorization": this.loginData.Token },
            data: {
                id: this.state.nftUserData.id,
                user_id: this.state.nftUserData.user_id,
                first_name: this.state.nftUserData.first_name,
                last_name: this.state.nftUserData.last_name,
                email: this.loginData?.data.user_email,
                is_approved: this.state.nftUserData.is_approved,
                description: this.state.nftUserData.description,
                facebook: this.state.nftUserData.facebook,
                youtube: this.state.nftUserData.youtube,
                twitter: this.state.nftUserData.twitter,
                insta: this.state.nftUserData.insta,
                nft_hash: this.state.nftUserData.nft_hash,
                city: this.state.nftUserData.city,
                follower: this.state.nftUserData.follower,
                product_name: this.state.nftUserData.product_name,
                product_description: this.state.nftUserData.product_description,
                ip: this.state.nftUserData.ip,
                datetime: this.state.nftUserData.datetime,
                user_name: this.state.nftUserData.user_name,
                banner: this.state.nftUserData.banner,
                profile_pic: this.state.nftUserData.profile_pic,
                telent_status: this.state.nftUserData.telent_status,
                talent_email: this.state.nftUserData.email,
            }
        }).then(response => {
            if (response.data.success === true) {
                        ...
                        <div className="container-fluid pt-25">
                            ...
                            <div className="row heading-bg">
                                <div className="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                    <h5 className="txt-dark">New Talent Details</h5>
                                </div>
                                {/* <!-- Breadcrumb --> */}
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div className="form-wrap">
                                    <form action="#">
                                        <h6 className="txt-dark capitalize-font"><i className="zmdi zmdi-info-outline mr-10"></i>About User</h6>
                                        <hr className="light-grey-hr" />
                                        <div className="row">
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    <label className="control-label mb-10">First Name <span className="errorAstrick">*</span></label>
                                                    <input type="text" onChange={this.nftUserDetail} name="first_name" className="form-control" placeholder="First Name" value={this.state.nftUserData?.first_name} />
                                                </div>
                                            </div>
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    <label className="control-label mb-10">Last Name <span className="errorAstrick">*</span></label>
                                                    <input type="text" onChange={this.nftUserDetail} name="last_name" className="form-control" placeholder="Last Name" value={this.state.nftUserData?.last_name} />
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    <label className="control-label mb-10">Country Name <span className="errorAstrick">*</span></label>
                                                    <select className="" name="country_id" onChange={this.nftUserDetail} value={this.state.nftUserData?.country_id} className="form-control" >
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    <label className="control-label mb-10">City <span className="errorAstrick">*</span></label>
                                                    <input type="text" onChange={this.nftUserDetail} name="city" className="form-control" placeholder="City" value={this.state.nftUserData?.city} />
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    <label className="control-label mb-10">Facebook </label>
                                                    <input type="text" onChange={this.nftUserDetail} name="facebook" className="form-control" placeholder="Facebook" value={this.state.nftUserData?.facebook} />
                                                </div>
                                            </div>

                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    <label className="control-label mb-10">Youtube</label>
                                                    <input type="text" onChange={this.nftUserDetail} name="youtube" className="form-control" placeholder="Youtube" value={this.state.nftUserData?.youtube} />
                                                </div>
                                            </div>

                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    <label className="control-label mb-10">Twitter</label>
                                                    <input type="text" onChange={this.nftUserDetail} name="twitter" className="form-control" placeholder="Twitter" value={this.state.nftUserData?.twitter} />
                                                </div>
                                            </div>

                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    <label className="control-label mb-10">Instagram</label>
                                                    <input type="text" onChange={this.nftUserDetail} name="insta" className="form-control" placeholder="Instagram" value={this.state.nftUserData?.insta} />
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-md-12">
                                                <div className="form-group">
                                                    <label className="control-label mb-10">Description <span className="errorAstrick">*</span></label>
                                                    <textarea onChange={this.nftUserDetail} name="description" className="form-control" placeholder="Description" value={this.state.nftUserData?.description}></textarea>
                                                </div>
                                            </div>
                            ...
                            <div class="modal-footer pt-0">
                                ...
                                <button type='submit' onClick={this.updateNftUser} disabled={!this.state.nftUserData?.first_name || !this.state.nftUserData?.last_name || !this.state.nftUserData?.city || !this.state.nftUserData?.description} className="btn btn-primary">Add </button>

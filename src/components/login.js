        ...
        axios.post(`${config.apiUrl}adminlogin`, data, { headers })
            .then(response => {
                ...
                if (response.data.success === true) {
                    ...
                    Cookies.set('loginSuccessblineAdmin', response.data);
                ...
                <header className="sp-header">
                    ...
                    <div className="brand-be">
                        <a href={`${config.baseUrl}`}>
                            ...
                            <img className="logo-c active be_logo" src="images/bline.png" alt="logo" style={{ width: "130px" }} />
                                ...
                                <div className="auth-form  ml-auto mr-auto no-float">
                                    <div className="row">
                                        <div className="col-sm-12 col-xs-12">
                                            <div className="mb-30">
                                                <h3 className="text-center txt-dark mb-10">Sign in to BLINE</h3>

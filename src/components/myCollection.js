...
export default class usercollection extends Component {
  constructor(props) {
    ...
    this.loginData = !Cookies.get("loginSuccessblineAdmin")
      ? []
      : JSON.parse(Cookies.get("loginSuccessblineAdmin"));
    ...
    this.columns = [
                ...
                {item.description.length > 50 ? (
                  <>
                    ...
                    <a
                      ...
                      data-toggle="modal"
                      onClick={this.viewmore.bind(this, item.description)}
          ...
          return (
            <>
              ...
              item.profile_pic === undefined ? (
                ...
                <a
                  href={`${config.imageUrl1}${item.profile_pic}`}
                  target="_blank"
                >
                  <img
                    src={`${config.imageUrl1}${item.profile_pic}`}
            ...
            <>
              ...
              item.banner === undefined ? (
                ...
                <a href={`${config.imageUrl1}${item.banner}`} target="_balnk">
                  <img
                    src={`${config.imageUrl1}${item.banner}`}
                    className="product-img"
                  />
                </a>
              )}
        ...
        cell: (item) => {
          return (
            <>
              <input
                type="checkbox"
                checked={item.is_featured === 0 ? "" : "checked"}
                onClick={this.updateAdminFeature.bind(
                  this,
                  item.id,
                  item.is_featured
                )}
      ...
      },
      {
        ...
        cell: (item) => {
          return (
            <>
              <p className="my_collection_icons">
                {item?.facebook === "" &&
                item?.insta === "" &&
                item?.telegram === "" &&
                item?.twitter === "" &&
          ...
          return (
            <>
              <button
                ...
                onClick={this.deleteUserAPI.bind(this, item)}
                data-original-title=""
              >
                {" "}
  ...
  async adminCollection() {
    await axios
      .get(`${config.apiUrl}getAdminCollection`, {})
      .then((result) => {
  ...
  deleteUserAPI(id) {
    if (id.totalNft == 0) {
        ...
        buttons: [
          {
            ...
            onClick: () =>
              axios
                .post(`${config.apiUrl}deleteAdminCollection`, { id: id.id })
                .then((result) => {
                  if (result.data.success === true) {
      ...
      toast.error("You cant delete this collection because of nft existing", {
        position: toast.POSITION.TOP_CENTER,
      });
    }
  }
  ...
  createCollectionAPI(e) {
    ...
    axios
      .post(`${config.apiUrl}insertAdminCollection`, formData)
      .then((result) => {
        if (result.data.success === true) {
          toast.success(result.data.msg, {
            style: {
                ...
                <div className="form-wrap">
                  <form action="#">
                    <h6 className="txt-dark capitalize-font">
                      <i className="zmdi zmdi-info-outline mr-10"></i>Add
                      Collection
                    </h6>
              ...
              <div class="modal-footer pt-0">
                ...
                {this.state.loader === "" ? (
                  <button
                    ...
                    onClick={this.createCollectionAPI}

                        ...
                        <div className="container-fluid pt-25">
                            ...
                            <div className="row heading-bg">
                                <div className="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                    <h5 className="txt-dark">product cart</h5>
                                </div>
                                {/* <!-- Breadcrumb --> */}
                                                ...
                                                <form id="example-advanced-form" action="#">
                                                    <div className="table-wrap">
                                                        <div className="table-responsive">
                                                            <table className="table display product-overview mb-30" id="datable_1">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Photo</th>
                                                                        <th>Product</th>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td className="txt-dark">Rounded Chair</td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td className="txt-dark">Circle Chair</td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td className="txt-dark">Square Chair</td>
                                                                        <td>
                                                            ...
                                                            <div className="form-actions pull-right pr-15">
                                                                <button className="btn btn-success btn-anim mr-10 pull-left"><i className="fa fa-shopping-cart"></i><span className="btn-text">continue shopping</span></button>
                                                                <button className="btn btn-primary btn-anim pull-left"><i className="fa fa-sign-out"></i><span className="btn-text">checkout</span></button>
                                                                <div className="clearfix"></div>
                                                            </div>
                                                        </div>
                                                    </div>

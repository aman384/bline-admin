...
export default class realestateusers extends Component {
            ...
            buttons: [
                {
                    ...
                    axios({
                        method: 'post',
                        url: `${config.apiUrl}realEstateUserApprove`,
            ...
            buttons: [
                {
                    ...
                    axios({
                        method: 'post',
                        url: `${config.apiUrl}realEstateUserReject`,
                        data: {  'email': id.email, 'user_id': id.user_id }
                     })
            .then(result => {
    ...
    async nftsuserList() {
        ...
        axios({
            method: 'get',
            url: `${config.apiUrl}getRealEstateUsers`,
            data: {}
         })
        
        
        // axios.get(`${config.apiUrl}getRealEstateUsers`, {}, )
                .then(result => {
     ...
     async getNftUserDetailAPI(id) {
       ...
       await axios({
         method: 'post',
         url: `${config.apiUrl}getUserRealEstate`,
         headers: { "Authorization": this.loginData.Token },
         data: { "user_id":  id }
       }).then(response => {
         if (response.data.success === true) {
    ...
    async updateNftUser(e) {
       ...
       await axios({
         method: 'post',
         url: `${config.apiUrl}updateRealEstateUser`,
         headers: { "Authorization": this.loginData.Token },
         data: this.state.nftUserData
       }).then(response => {
         if (response.data.success === true) {

...
export default class realestatecollection extends Component {
    ...
    async nftsuserList() {
        await    axios.get(`${config.apiUrl}getAllRealEstateCollection`, {}, )
                .then(result => {
        ...
        deleteItem = (id) => {
            confirmAlert({
                ...
                message: 'Are you sure to delete this real estate collection.',
                buttons: [
                    {
                        label: 'Yes',
                        onClick: () =>
                        ...
                        <div className="container-fluid pt-25">
                            ...
                            <div className="row heading-bg">
                                <div className="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                    <h5 className="txt-dark">Real State Collection</h5>
                                </div>
                                {/* <!-- Breadcrumb --> */}

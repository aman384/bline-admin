                    ...
                    <div className="accordion accordion-flush" id="accordionFlushExample" >
                      ...
                      <div className="accordion-item" >
                        <h2 className="accordion-header" id="flush-headingOne">
                          <button className="market-place accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="true" aria-controls="flush-headingOne">
                            Status
                          </button>
                        </h2>
                        <div id="flush-collapseOne" className="accordion-collapse collapse" aria-labelledby="flush-headingOne" style={{ backgroundSize: 'cover' }}>
                      ...
                      <div className="accordion-item" >
                        ...
                        <div id="flush-collapseTwo" className="accordion-collapse collapse" aria-labelledby="flush-headingTwo" style={{ backgroundSize: 'cover' }}>
                          <div className="accordion-body Panel--isContentPadded FeaturedFilter--items">
                      ...
                      <div className="accordion-item collection-filter" >
                        ...
                        <div id="flush-collapseThird" className="accordion-collapse collapse collection" aria-labelledby="flush-headingThird" style={{ backgroundSize: 'cover' }}>
                          <div className="accordion-body Panel--isContentPadded FeaturedFilter--items">
                      ...
                      <div className="accordion-item " >
                        ...
                        <div id="flush-collapseFour" className="accordion-collapse collapse" aria-labelledby="flush-headingFour"  style={{ backgroundSize: 'cover' }}>
                          <div className="accordion-body Panel--isContentPadded FeaturedFilter--items">
                    ...
                    <aside style={{position:"sticky", top:"80px"}}>
                      ...
                      <Accordion defaultActiveKey={['0']} alwaysOpen>
                        ...
                        <Accordion.Item eventKey="4">
                          <Accordion.Header><p>Games</p> </Accordion.Header>
                          <Accordion.Body>
                          <div className=" gUuGNP CategoryFilter--panel">
                              <div className="Scrollbox--content">
                                {this.state.gamesResponse.map(item => {
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                              <div className="nft__item">
                                ...
                                {(item.sell_type === 2 && new Date(item.start_date) > new Date()) && item.start_date != '0000-00-00 00:00:00' && item.start_date !== null && item.start_date != '' ?
                                  ...
                                  :
                                  item.sell_type === 2 && item.expiry_date != '0000-00-00 00:00:00' && item.expiry_date !== null && item.expiry_date != '' ?
                                    <div className="de_countdown is-countdown" >
                                      <Countdown
